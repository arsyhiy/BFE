...
@onready var audio_manager : PackedScene = preload("../../Audio/AudioManager/Scenes/audio_manager_scene.tscn")
@export var explosion_sound : AudioStream

@export_group("Particles variables")
@onready var explosion_particle_effect : PackedScene = preload("../../Effects/ParticlesEffects/ExplosionParticleEffect/Scenes/explosion_particle_effect_scene.tscn")
